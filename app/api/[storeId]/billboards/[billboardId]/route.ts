...
export async function GET(
  ...
  try {
    ...
    const billboard = await prisma_db.billboard.findUnique({
      where: {
...
export async function PATCH(
  ...
  try {
    ...
    const billboard = await prisma_db.billboard.updateMany({
      where: {
        id: params.billboardId,
      },
      data: {
...
export async function DELETE(
  ...
  try {
    ...
    const billboard = await prisma_db.billboard.deleteMany({
      where: {
        id: params.billboardId,
      },
    });
